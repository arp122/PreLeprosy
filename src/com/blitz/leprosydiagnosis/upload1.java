...
public class upload1 extends Activity 
{
	...
	String upLoadServerUri = "http://ieeevit.com/jugaadathon/main.php";
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		catch(NullPointerException e)
		{
		 ...
		 Upload("/mnt/sdcard/Leprosy/Normal/image.jpg",0);
	}
             ...
             try {
               ...
               InputStreamReader isr = new InputStreamReader(conn.getInputStream());
     			...
     			try
				{
					...
					editor.putString("json1", ""+response);
					editor.commit();
				...
				catch(JSONException e)
				{
                 ...
                 Intent i = new Intent(upload1.this, upload2.class);
                 startActivity(i);
                 finish();
